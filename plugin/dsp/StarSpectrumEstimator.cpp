/* StarSpectrumEstimator.cpp from Stand http://github.com/qtau-devgroup/stand by HAL@ShurabaP, BSD license */
#include <qmath.h>
...
void StarSpectrumEstimator::estimate(double *dst, float *wave, float ms, float f0, int fs, int length)
{
    ...
    _estimatePowerSpectrum(dst, wave, ms, f0, fs, length);
...
void StarSpectrumEstimator::_smootheSpectrum(double *dst, float f0, int fftLength, int fs)
{
